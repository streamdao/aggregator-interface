...
export const STREAM_PROGRAM_ID = new PublicKey(REACT_APP_STREAM)
...
export const STREAM_MINT_ADDRESS = new PublicKey('4ThReWAbAVZjNVgs5Ui9Pk3cZ5TYaD9u6Y89fp6EFzoF')
